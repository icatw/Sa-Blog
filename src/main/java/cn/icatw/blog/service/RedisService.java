...
public interface RedisService {
    ...
    Long execute(RedisScript<Long> redisScript, ImmutableList<String> keys, int limitCount, int limitPeriod);

    /**
     * 点赞操作
     *
     * @param bizId           业务id
     * @param prefixUserLike  点赞模块前缀
     * @param prefixLikeCount 前缀式计数
     */
    void likeOpt(Integer bizId, String prefixUserLike, String prefixLikeCount);
